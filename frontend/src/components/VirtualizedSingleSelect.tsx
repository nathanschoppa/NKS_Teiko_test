...
import { Box, TextField, Paper, ListItem, ListItemText, Chip, ClickAwayListener } from '@mui/material'
...
const VirtualizedSingleSelect = ({ options, value, onChange, label, width = 300 }: Props) => {
